...
# TODO Для восприятия и поддержки кода будет хорошо заменить or на еще одно условие через elif
...
# TODO Решение верное, только замените все-таки числа на переменные hole_x и hole_y
#  и or на elif. И PEP 8
