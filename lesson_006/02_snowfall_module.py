...
# TODO Через глобальную переменную. Передали в функцию создать_снежинки количество снежинок, а она уже записала
...
# TODO Да нужно. Весь алгоритм нужно разделить именно на атомарные операции - создать, нарисовать, сдвинуть, удалить -
