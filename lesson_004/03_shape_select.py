...
# TODO Здесь применим все замечания из 02.
#  Тут тоже можно сделать общий словарь, только вместо цветов использовать функции (именно как объекты, без вызова).
#  А уже при получении ввода от юзера брать из словаря нужную функцию и делать ее вызов
